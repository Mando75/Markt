...
export class CreateGroupAndPlayerTables1548472401439
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "players" ADD CONSTRAINT "FK_d14692e738d6f44d064c44d87a0" FOREIGN KEY ("guide_id") REFERENCES "guides"("id")`
    );
    await queryRunner.query(
      `ALTER TABLE "players" ADD CONSTRAINT "FK_6ef6494ecfce4b57b10d487b181" FOREIGN KEY ("group_id") REFERENCES "groups"("id")`
    );
    await queryRunner.query(
      `ALTER TABLE "groups" ADD CONSTRAINT "FK_6dcd3411b1ed963e5fa9392c6bf" FOREIGN KEY ("guide_id") REFERENCES "guides"("id")`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      `ALTER TABLE "groups" DROP CONSTRAINT "FK_6dcd3411b1ed963e5fa9392c6bf"`
    );
    await queryRunner.query(
      `ALTER TABLE "players" DROP CONSTRAINT "FK_6ef6494ecfce4b57b10d487b181"`
    );
    await queryRunner.query(
      `ALTER TABLE "players" DROP CONSTRAINT "FK_d14692e738d6f44d064c44d87a0"`
    );
